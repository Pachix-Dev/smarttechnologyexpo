      ...
      >
        ...
        <div>
          ...
          >
            ...
            <span className="text-[#9f2e26]" aria-hidden="true">
              *
            </span>
          </label>
          <input
            ...
            placeholder={language === 'es' ? 'Empresa S.A. de C.V.' : 'Company Ltd.'}
            required
        ...
        <div>
          <label
            ...
            className="flex items-center gap-1 mb-1 text-sm font-semibold text-gray-800"
          >
            <span>{language === 'es' ? 'Sector' : 'Industry'}</span>
            <span className="text-[#9f2e26]" aria-hidden="true">
              *
            </span>
          </label>
          ...
          >
            ...
            <option value="Manufactura Inteligente - Industria 4.0 / Smart Manufacturing - Industry 4.0">
              Manufactura Inteligente - Industria 4.0 / Smart Manufacturing -
              Industry 4.0
            </option>
            <option value="Motion Control y Sistemas de Accionamiento / Motion Control and Drive Systems">
              Motion Control y Sistemas de Accionamiento / Motion Control and
              Drive Systems
            </option>
            <option value="Inteligencia Artificial y Machine Learning en Automatización / Artificial Intelligence and Machine Learning in Automation">
              Inteligencia Artificial y Machine Learning en Automatización /
            ...
            <option value="Logística, Manejo de Materiales y Automatización de Almacenes / Logistics, Material Handling, and Warehouse Automation">
              Logística, Manejo de Materiales y Automatización de Almacenes /
              Logistics, Material Handling, and Warehouse Automation
            </option>
            <option value="Seguridad Industrial, Ciberseguridad y Estándares / Industrial Safety, Cybersecurity, and Standards">
              Seguridad Industrial, Ciberseguridad y Estándares / Industrial
            ...
            <option value="Software de Automatización e Integración de Sistemas / Automation Software and Systems Integration">
              Software de Automatización e Integración de Sistemas / Automation
              Software and Systems Integration
            </option>
            <option value="Drone Innovators Forum">Drones</option>
          </select>
        </div>
        {/* Nombre: Nombre completo de la persona de contacto. Obligatorio. */}
        <div>
        ...
        <div>
          <label
            ...
            className="flex items-center gap-1 mb-1 text-sm font-semibold text-gray-800"
          >
            <span>{language === 'es' ? 'Correo electrónico' : 'Email'}</span>
            <span className="text-[#9f2e26]" aria-hidden="true">
              *
            </span>
          </label>
        ...
        <div>
          ...
          <div
            className="w-full rounded-lg flex flex-col md:flex-row gap-3"
            role="group"
            aria-labelledby="countrycodes"
          >
            <div className="w-52">
            ...
            <div className="w-full">
              ...
              <input
                ...
                placeholder={language === 'es' ? 'Ingresa el número de teléfono' : 'Enter phone number'}
                required
                id="phone"
                name="phone"
                autoComplete="phone"
        ...
        <div className="sm:col-span-2">
          ...
          <p className="mt-1 text-xs text-gray-600">
            {language === 'es' ? 'Sé específico para que podamos ayudarte mejor.' : 'Be specific so we can help you better.'}
          </p>
        </div>
        {sendStatus ? (
