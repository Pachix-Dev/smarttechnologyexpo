const hotels = [
  {
    ...
    name: "AC Marriott Guadalajara Expo",
    address:
      "Av. López Mateos Sur 2375, Plaza del Sol, 45055 Zapopan, Jalisco.",
    rate: "$1,620 MXN",
    phone: "+52 (33) 38 80 06 00",
    email: "reservaciones.gdlar@fibrainn.mx",
    code: "",
    code_label_es: "La promoción aplica directo con el hotel",
    code_label_en: "The promotion applies directly with the hotel",
    link: "https://app.marriott.com/reslink?id=1786117207521&key=GRP&app=resvlink",
    time_walk: "20",
    time_drive: "5",
    whatsapp: "",
  },
  {
    ...
    email: "guadalajara.res@barcelo.com / guadalajara.res2@barcelo.com",
    code: "SMART TECHOLOGIES EXPO",
    code_label_es: "La promoción aplica directamente con el hotel",
    code_label_en: "The promotion applies directly with the hotel",
    link: "",
    time_walk: "1",
    time_drive: "1",
  ...
  },
  {
    ...
    address:
      "Av. Mariano Otero 1400 Col, Jardines del Bosque, 44520 Guadalajara, Jalisco.",
    rate: "Sencilla $946.28 MXN <br/> Doble $1,144.63 MXN",
    phone: "+52 (33) 3880 9600",
    email: "elsa.alvarado@accor.com",
    code: "SMART 2026",
    code_label_es: "La promoción aplica directo con el hotel",
    code_label_en: "The promotion applies directly with the hotel",
    link: "",
  ...
  },
  {
    ...
    address:
      "Av. López Mateos, 830 - Fracc. Chapalita · 44500 Guadalajara, Jalisco",
    rate: "$2,490 MXN",
    phone: "01 800 225 5748",
    email: "customerservices.zgd@riu.com",
    code: "SMARTT",
    code_label_es: "La promoción aplica directo con el hotel",
    code_label_en: "The promotion applies directly with the hotel",
  ...
  },
  {
    ...
    address:
      "Av. Mariano Otero 1550 Col, Rinconada del Sol, 45055 Guadalajara, Jalisco.",
    rate: "$1,800 MXN",
    phone: "+52 (33) 3669 3200",
    email: "ventas2figdl@posadas.com",
    code: "",
    code_label_es: "La promoción aplica directo con el hotel",
    code_label_en: "The promotion applies directly with the hotel",
    link: "",
  ...
  },
  {
    ...
    rate: "$0 MXN",
    phone: "+52 33 3880 9200",
    email: "ventas1gdex@posadas.com",
    code: "G1XBKT@OGX",
    code_label_es: "La promoción aplica directo con el hotel",
    code_label_en: "The promotion applies directly with the hotel",
    link: "https://www.corpo-rate.com/login?groupId=G1XBKT@OGX",
    time_walk: "15",
    time_drive: "5",
    whatsapp: "33 3880 9200",
  },
  {
    src: "/voco.webp",
    name: "VOCO GUADALAJARA EXPO",
    address: "Av. Mariano Otero #1326 Jardines de San Ignacio Guadalajara, JAL",
    rate: "",
    phone: "3347312870",
    email: "reservaciones.gdlea@aimbridgelatam.com",
    code: "SMARTVOCO2026 ",
    code_label_es: "La promoción aplica directo con el hotel",
    code_label_en: "The promotion applies directly with the hotel",
    link: "https://www.ihg.com/redirect?path=asearch&brandCode=vx&localeCode=es&regionCode=1&hotelCode=GDLEA&checkInDate=16&checkInMonthYear=102026&checkOutDate=21&checkOutMonthYear=102026&numberOfAdults=1&numberOfChildren=0&numberOfRooms=1&rateCode=6CBARC&_PMID=99801505&GPC=KNS&cn=no&adjustMonth=false&showApp=true&monthIndex=00",
    time_walk: "6",
    time_drive: "5",
    whatsapp: "",
  },
  ...
  //   address:
  //     "Av. Niños Héroes 3089 Col. Jardines de los Arcos C.P. 44500, Guadalajara, Jalisco.",
  //   rate: "$1,500 MXN",
  ...
  //   address:
  //     "Av. López Mateos Sur 2500 Col. Ciudad del Sol, C.P. 45050, Guadalajara, Jalisco.",
  //   rate: "$1,500 MXN",
  ...
  //   name: "Wyndham Garden",
  //   address:
  //     "Av. Mariano Otero 3875 Col. Ciudad del Sol, C.P. 45050, Guadalajara, Jalisco.",
  //   rate: "$1,290 MXN",
  ...
  //   address:
  //     "Av. de las Rosas 3030 Col. Chapalita, C.P. 44500, Guadalajara, Jalisco.",
  //   rate: "$1,950 MXN",
...
const restaurants = [
  {
    ...
    name: "Cocina Tres16",
    description_es:
      "Ubicado a menos de 5 minutos de la Expo, es una opción conveniente para desayunar o almorzar, abriendo de 8 AM a 5 PM todos los días.",
    description_en:
      "Located less than a 5-minute walk from the Expo, it is a convenient option for breakfast or lunch, open from 8 AM to 5 PM every day.",
  ...
  },
  {
    ...
    description_es:
      "Restaurante de comida mexicana contemporánea ubicado dentro del hotel Barceló Guadalajara.",
    description_en:
      "Contemporary Mexican cuisine restaurant located inside the Barceló Guadalajara hotel.",
  ...
  },
  {
    ...
    description_es:
      "Si buscas comida italiana, este es un restaurante bien valorado en la zona",
    description_en:
      "If you are looking for Italian food, this is a highly rated restaurant in the area.",
  ...
  },
  {
    ...
    description_es:
      "La Perla es una plaza moderna en Zapopan con tiendas, áreas verdes y espacios para pasear y disfrutar al aire libre.",
    description_en:
      "La Perla is a modern mall in Zapopan with stores, green areas, and spaces to stroll and enjoy the outdoors.",
...
const gastronomiaLocal = [
  {
    ...
    name: "Santo Coyote",
    description_es:
      "Es un lugar que ofrece una experiencia única donde se combinan sabores, aromas y espacios llenos de magia, cultura y misticismo mexicano. El restaurante celebra la fusión de dos razas en Nuevo México, dando origen a la cocina criolla y reflejando tradiciones paganas con calidez y orgullo en cada rincón.",
    description_en:
      "It is a place that offers a unique experience where flavors, aromas, and spaces full of magic, culture, and Mexican mysticism are combined. The restaurant celebrates the fusion  of two races in New Mexico, giving rise to Creole cuisine and reflecting pagan traditions with warmth and pride in every corner.",
    link: "",
  },
  {
    ...
    name: "Casa bariachi",
    description_es:
      "Casa Bariachi abrió en 1995 en Guadalajara para ofrecer a visitantes nacionales y extranjeros una experiencia llena de hospitalidad, mariachi y folklore mexicano. El lugar combina excelente gastronomía, música tradicional, bailes regionales y bebidas mexicanas en una fiesta colorida y alegre que celebra la cultura de México.",
    description_en:
      "Casa Bariachi opened in 1995 in Guadalajara to offer national and international visitors an experience full of hospitality, mariachi, and Mexican folklore. The place combines excellent gastronomy, traditional music, regional dances, and Mexican drinks in a colorful and joyful party that celebrates Mexican culture.",
    link: "",
  },
  {
    ...
    name: "Abajeño",
    description_es:
      "Ofrece una experiencia gastronómica única con platillos 100% mexicanos de sabores auténticos y tradicionales transmitidos de generación en generación. Cada plato está diseñado para deleitar tu paladar con recetas excepcionales de la cocina mexicana.",
    description_en:
      " It offers a unique gastronomic experience with 100% Mexican dishes of authentic and traditional flavors passed down from generation to generation. Each dish is designed to delight your palate with exceptional recipes from Mexican cuisine.",
    link: "",
  },
  {
    ...
    description_es:
      "Es un famoso restaurante de Guadalajara con Récord Guinness por servir comida en menos de 20 segundos. Desde 1970, su especialidad es la Carne en su Jugo, un ícono tapatío que llega a la mesa casi instantáneamente junto con aperitivos como frijoles, cebolla y limón.",
    description_en:
      " It is a famous restaurant in Guadalajara with a Guinness World Record for serving food in less than 20 seconds. Since 1970, its specialty has been Carne en su Jugo, a Tapatío icon that arrives at the table almost instantly along with appetizers such as beans, onion, and lime.",
    link: "",
  },
];
...
const gastronomiaGurmet = [
  ...
  },
  {
    ...
    name: "Octo",
    description_es:
      "Es un restaurante único en Guadalajara que combina arquitectura impresionante de ladrillo hexagonal con exposiciones de arte. Su menú se especializa en comida del mar y carnes selectas, complementado con mixología elaborada con destilados mexicanos. Ganador del PRIX VERSAILLES 2022.",
    description_en:
      "Es un restaurante único en Guadalajara que combina arquitectura impresionante de ladrillo hexagonal con exposiciones de arte. Su menú se especializa en comida del mar y carnes selectas, complementado con mixología elaborada con destilados mexicanos. Ganador del PRIX VERSAILLES 2022.",
    link: "",
  },
  {
    ...
    description_en:
      "Chef Óscar Garza's task has been to innovate in the preparation of traditional Mexican dishes, intervening with techniques, processes, and new flavors to obtain abstract and contemporary pieces turned into dishes, always respecting the essence of each recipe while adhering to tradition.",
    link: "",
  },
  {
    ...
    name: "Alcalde",
    description_es:
      "Fundado en 2013, ofrece cocina viva y sincera que respeta las estaciones del año y los ciclos de la tierra. Busca la excelencia en lo sencillo, presentando gastronomía actual sin artificios, solo sabor auténtico.",
    description_en:
      "Founded in 2013, it offers lively and sincere cuisine that respects the seasons of the year and the cycles of the earth. It seeks excellence in simplicity, presenting contemporary gastronomy without artifice, only authentic flavor.",
    link: "",
  },
];
...
const parques = [
  {
    ...
    description_es:
      "Descubre el corazón cultural de Guadalajara: recorre su arquitectura colonial y visita la Catedral, el Cabañas y el Degollado.",
    description_en:
      " Discover the cultural heart of Guadalajara: explore its colonial architecture and visit the Cathedral, Cabañas, and Degollado.",
  ...
  },
  {
    ...
    name: "Tlaquepaque",
    description_es:
      "Recorre las coloridas calles de este pueblo mágico cercano y descubre su riqueza artística y artesanal.",
    description_en:
      "Stroll through the colorful streets of this nearby magical town and discover its artistic and artisanal treasures.",
  ...
  },
  {
    ...
    name: "Tour a Tequila",
    description_es:
      "Visita el pueblo de Tequila, conoce cómo se elabora la bebida y disfruta un recorrido en tren.",
    description_en:
      " Visit the town of Tequila, learn how the drink is made, and enjoy a train tour.",
  ...
  },
  {
    ...
    name: "Acuario Michin",
    description_es:
      "Ubicado en pleno centro de la ciudad, con una amplia variedad de peces y rayas que enriquecen la experiencia de los visitantes",
    description_en:
      "Located in the heart of the city, with a wide variety of fish and rays that enrich the visitor experience.",
  ...
  },
  {
    ...
    description_es:
      "Un espacio verde ideal para caminatas, picnics y actividades al aire libre, ubicado a solo 10 minutos en coche de la Expo Guadalajara.",
    description_en:
      "A green space ideal for walks, picnics, and outdoor activities, located just a 10-minute drive from Expo Guadalajara.",
  ...
  },
  {
    ...
    name: "Selva Mágica",
    description_es:
      "Un parque de atracciones lleno de emoción y diversión, perfecto para los amantes de las aventuras extremas",
    description_en:
      "An amusement park full of excitement and fun, perfect for lovers of extreme adventures.",
  ...
  },
  {
    ...
    description_es:
      "Vive el ambiente tradicional tapatío en este lugar emblemático.  ",
    description_en:
      " Experience the traditional Tapatío atmosphere in this iconic place.",
